...
vertexShader(uint                   vertexID             [[ vertex_id ]],
             constant CRTVertex   *vertexArray          [[ buffer(CRTVertexIndexVertices) ]],
             constant vector_uint2 *viewportSizePointer  [[ buffer(CRTVertexIndexViewportSize) ]])
                               ...
                               texture2d<half> samplingTexture [[ texture(CRTTextureIndexInput) ]])
{
    ...
    const half4 colorSample = samplingTexture.sample (textureSampler, in.textureCoordinate);
